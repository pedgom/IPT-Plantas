<?php
view()->share('pageTitle', __('Forma Arbusto Atributos'));
        ...
        <div class="card-header">
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="{{ __('Search Forma Arbusto Atributo') }}" />
                </div>
                <!--end::Search-->
            </div>
    ...
    @push('scripts')
        ...
        <script>
            ...
            $(function(){
                ...
                var buttons = new $.fn.dataTable.Buttons(window.LaravelDataTables["forma_arbusto_atributos-table"], {
                    buttons: [
                        'export',
                    ]
                }).container().appendTo($('#datatable-buttons'));
                handleSearchDatatable(window.LaravelDataTables["forma_arbusto_atributos-table"]);
            });
                ...
                swal.fire({
                    ...
                    if (result.value) {
                        ...
                        jQuery.ajax({
                            ...
                            jQuery('#forma_arbusto_atributos-table').DataTable().draw(false);
                        });
                    }
                });
            }
