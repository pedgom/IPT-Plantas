        ...
        <div class="card-header">
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" data-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="{{ __('Search settings') }}" />
                </div>
                <!--end::Search-->
            </div>
    ...
    @push('scripts')
        ...
        <script>
            $(function(){
                ...
                handleSearchDatatable(window.LaravelDataTables["settings-table"]);
            });
