    ...
    @else
        ...
        <div class="d-flex flex-column flex-root">
            ...
            @endif
                ...
                <!--begin::Wrapper-->
                <div style="background-size: auto; background-position: center;background-image: url({{url('images/background.jpg')}}); width:1000px" class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
