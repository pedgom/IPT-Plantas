<x-auth-layout>
    ...
    @if(config('recaptchav3.enable'))
        {!! RecaptchaV3::field('register', 'g-recaptcha-response', true, 'kt_sign_up_form') !!}
    @endif
    <!--begin::Heading-->
        ...
        <div class="text-center">
            <button type="submit" id="kt_sign_up_submit" class="btn btn-lg btn-primary" @if(config('recaptchav3.enable')) onclick="onClickRecaptcha(event)" @endif>
