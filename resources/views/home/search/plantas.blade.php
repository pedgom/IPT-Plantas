        ...
        <div class="row g-5 g-xl-9 mb-5 mb-xl-9">
            ...
            <div class="col-sm-3 mb-3 mb-sm-0">
                ...
                <div class="m-0">
                    ...
                    <div class="m-0">
                        <!--begin::Title-->
                        <a href="#" class="text-gray-800 text-hover-primary fs-3 fw-bolder d-block mb-2">Daily Podcast</a>
                        <!--end::Title-->
            ...
            <div class="col-sm-3 mb-3 mb-sm-0">
                ...
                <div class="m-0">
                    ...
                    <div class="m-0">
                        <!--begin::Title-->
                        <a href="#" class="text-gray-800 text-hover-primary fs-3 fw-bolder d-block mb-2">Neon Lights</a>
                        <!--end::Title-->
                        <span class="fw-bolder fs-6 text-gray-400 d-block lh-1">Wade Warren</span>
                    </div>
                    <!--end::Info-->
                </div>
                <!--end::Player card-->
            ...
            <div class="col-sm-3 mb-3 mb-sm-0">
                ...
                <div class="m-0">
                    ...
                    <div class="m-0">
                        <!--begin::Title-->
                        <a href="#" class="text-gray-800 text-hover-primary fs-3 fw-bolder d-block mb-2">Single Eye</a>
                        <!--end::Title-->
                        <span class="fw-bolder fs-6 text-gray-400 d-block lh-1">Robert Fox</span>
                    </div>
                    <!--end::Info-->
                </div>
                <!--end::Player card-->
            ...
            <div class="col-sm-3 mb-3 mb-sm-0">
                ...
                <div class="m-0">
                    ...
                    <div class="m-0">
                        <!--begin::Title-->
                        <a href="#" class="text-gray-800 text-hover-primary fs-3 fw-bolder d-block mb-2">Radiohead</a>
                        <!--end::Title-->
                        <span class="fw-bolder fs-6 text-gray-400 d-block lh-1">Jacob Jones</span>
                    </div>
                    <!--end::Info-->
                </div>
                <!--end::Player card-->
        ...
        <div class="row g-5 g-xl-9 mb-xl-3">
            ...
            <div class="col-sm-3 mb-3 mb-sm-0">
                ...
                <div class="m-0">
                    ...
                    <div class="m-0">
                        <!--begin::Title-->
                        <a href="#" class="text-gray-800 text-hover-primary fs-3 fw-bolder d-block mb-2">It is what it is</a>
                        <!--end::Title-->
                        <span class="fw-bolder fs-6 text-gray-400 d-block lh-1">Jane Cooper</span>
                    </div>
                    <!--end::Info-->
                </div>
                <!--end::Player card-->
            ...
            <div class="col-sm-3 mb-3 mb-sm-0">
                ...
                <div class="m-0">
                    ...
                    <div class="m-0">
                        <!--begin::Title-->
                        <a href="#" class="text-gray-800 text-hover-primary fs-3 fw-bolder d-block mb-2">Broken Mirros</a>
                        <!--end::Title-->
                        <span class="fw-bolder fs-6 text-gray-400 d-block lh-1">Jenny Wilson</span>
                    </div>
                    <!--end::Info-->
                </div>
                <!--end::Player card-->
            ...
            <div class="col-sm-3 mb-3 mb-sm-0">
                ...
                <div class="m-0">
                    ...
                    <div class="m-0">
                        <!--begin::Title-->
                        <a href="#" class="text-gray-800 text-hover-primary fs-3 fw-bolder d-block mb-2">The Hood</a>
                        <!--end::Title-->
                        <span class="fw-bolder fs-6 text-gray-400 d-block lh-1">Albert Flores</span>
                    </div>
                    <!--end::Info-->
                </div>
                <!--end::Player card-->
            ...
            <div class="col-sm-3">
                ...
                <div class="m-0">
                    ...
                    <div class="m-0">
                        <!--begin::Title-->
                        <a href="#" class="text-gray-800 text-hover-primary fs-3 fw-bolder d-block mb-2">Cirle Lights</a>
                        <!--end::Title-->
                        <span class="fw-bolder fs-6 text-gray-400 d-block lh-1">Dianne Russell</span>
                    </div>
                    <!--end::Info-->
                </div>
                <!--end::Player card-->
