        ...
        <div class="card-header">
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="{{ __('Search Demo') }}" />
                </div>
                <!--end::Search-->
            </div>
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <a href="{{ route('demos.create') }}" class="btn btn-primary">
    ...
    @push('scripts')
        ...
        <script>
            ...
            $(function(){
                ...
                var buttons = new $.fn.dataTable.Buttons(window.LaravelDataTables["demos-table"], {
                    buttons: [
                        'export',
                    ]
                }).container().appendTo($('#datatable-buttons'));
                handleSearchDatatable(window.LaravelDataTables["demos-table"]);
            });
                ...
                swal.fire({
                    ...
                    if (result.value) {
                        ...
                        jQuery.ajax({
                            ...
                            jQuery('#demos-table').DataTable().draw(false);
                        });
                    }
                });
            }
