    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <a href="{{ route('demos.edit', $demo) }}" class="btn btn-sm btn-flex btn-light-primary me-2">
                ...
                {!! Form::open(['route' => ['demos.destroy', $demo], 'method' => 'delete', 'class'=>"d-none", 'id' => 'delete-form']) !!}
                {!! Form::close() !!}
            </div>
        </div>
        <div class="card-body">
