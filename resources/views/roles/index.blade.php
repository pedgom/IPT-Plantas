<?php
view()->share('pageTitle', __('Roles'));
view()->share('hideSubHeader', false);
?>
<x-base-layout>
    @section('breadcrumbs')
        ...
        <div class="card-header">
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" data-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="{{ __('Search roles') }}" />
                </div>
                <!--end::Search-->
            </div>
    ...
    @push('scripts')
        ...
        <script>
            $(function(){
                ...
                var buttons = new $.fn.dataTable.Buttons(window.LaravelDataTables["roles-table"], {
                    buttons: [
                        'export',
                    ]
                }).container().appendTo($('#datatable-buttons'));
                handleSearchDatatable(window.LaravelDataTables["roles-table"]);
            });
