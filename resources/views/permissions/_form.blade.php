...
/**
 *
 * @var $permission \App\Models\Permission | null
 * @var $errors Illuminate\View\Middleware\ShareErrorsFromSession
 *
 */
?>

{!! Form::model($permission, ['route' => \Illuminate\Support\Facades\Route::currentRouteName() == 'permissions.create' ? ['permissions.store'] : ['permissions.update', $permission], 'method' => \Illuminate\Support\Facades\Route::currentRouteName() == 'permissions.create' ? 'post' : 'patch', 'class' => "form"]) !!}
<div class="card-body">
    <div class="mb-10">
