<?php
view()->share('pageTitle', __('Origem Atributos'));
view()->share('hideSubHeader', true);
?>
<x-base-layout>
    @section('breadcrumbs')
        {{ Breadcrumbs::render('origem-atributos.index') }}
    @endsection
    @push('firstStyles')
        ...
        <div class="card-header">
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="{{ __('Search Origem Atributo') }}" />
                </div>
                <!--end::Search-->
            </div>
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <a href="{{ route('origem-atributos.create') }}" class="btn btn-primary">
                        {!! theme()->getSvgIcon("icons/duotune/arrows/arr075.svg", "svg-icon-2") !!}
                        {{ __('New Origem Atributo') }}
                    </a>
    ...
    @push('scripts')
        ...
        <script>
            ...
            $(function(){
                ...
                var buttons = new $.fn.dataTable.Buttons(window.LaravelDataTables["origem_atributos-table"], {
                    buttons: [
                        'export',
                    ]
                }).container().appendTo($('#datatable-buttons'));
                handleSearchDatatable(window.LaravelDataTables["origem_atributos-table"]);
            });
                ...
                swal.fire({
                    ...
                    if (result.value) {
                        ...
                        jQuery.ajax({
                            ...
                            jQuery('#origem_atributos-table').DataTable().draw(false);
                        });
                    }
                });
            }
