...
class SoloAtributoDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($soloAtributo) {
                return '<a class="btn btn-sm btn-bg-light btn-color-primary btn-icon" href="'. route('solo-atributos.show', $soloAtributo) .'" title="'. __('View') .'">'. theme()->getSvgIcon("icons/duotune/general/gen004.svg", "svg-icon-2") .'</a>
                        <a class="btn btn-sm btn-bg-light btn-color-primary btn-icon" href="'. route('solo-atributos.edit', $soloAtributo) .'" title="'. __('Edit') .'">'. theme()->getSvgIcon("icons/duotune/art/art005.svg", "svg-icon-2") .'</a>
                        <button class="btn btn-sm btn-bg-light btn-color-primary btn-icon delete-confirmation" data-destroy-form-id="destroy-form-'. $soloAtributo->id .'" data-delete-url="'. route('solo-atributos.destroy', $soloAtributo) .'" onclick="destroyConfirmation(this)" title="'. __('Delete') .'">'. theme()->getSvgIcon("icons/duotune/general/gen027.svg", "svg-icon-2") .'</button>';
            })
     ...
     *
     * @param \App\Models\SoloAtributo $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(SoloAtributo $model)
    {
    ...
    {
        return $this->builder()
            ->setTableId('solo_atributos-table')
    ...
    {
        return 'solo_atributos_' . date('YmdHis');
    }
}
