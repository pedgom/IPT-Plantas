...
class SituacaoEcologicaAtributoDataTable extends DataTable
{
     ...
     *
     * @param \App\Models\SituacaoEcologicaAtributo $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(SituacaoEcologicaAtributo $model)
    {
    ...
    {
        return $this->builder()
            ->setTableId('situacao_ecologica_atributos-table')
    ...
    {
        $model = new SituacaoEcologicaAtributo();
        return [
            Column::make('situacao_ecologica')->title($model->getAttributeLabel('situacao_ecologica')),
    ...
    {
        return 'situacao_ecologica_atributos_' . date('YmdHis');
    }
}
