...
class AlturaAtributoDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($alturaAtributo) {
                return '<a class="btn btn-sm btn-bg-light btn-color-primary btn-icon" href="'. route('altura-atributos.show', $alturaAtributo) .'" title="'. __('View') .'">'. theme()->getSvgIcon("icons/duotune/general/gen004.svg", "svg-icon-2") .'</a>
                        <a class="btn btn-sm btn-bg-light btn-color-primary btn-icon" href="'. route('altura-atributos.edit', $alturaAtributo) .'" title="'. __('Edit') .'">'. theme()->getSvgIcon("icons/duotune/art/art005.svg", "svg-icon-2") .'</a>
                        <button class="btn btn-sm btn-bg-light btn-color-primary btn-icon delete-confirmation" data-destroy-form-id="destroy-form-'. $alturaAtributo->id .'" data-delete-url="'. route('altura-atributos.destroy', $alturaAtributo) .'" onclick="destroyConfirmation(this)" title="'. __('Delete') .'">'. theme()->getSvgIcon("icons/duotune/general/gen027.svg", "svg-icon-2") .'</button>';
            })
     ...
     *
     * @param \App\Models\AlturaAtributo $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(AlturaAtributo $model)
    {
    ...
    {
        return $this->builder()
            ->setTableId('altura_atributos-table')
    ...
    {
        return 'altura_atributos_' . date('YmdHis');
    }
}
