...
class ColecaoAtributoDataTable extends DataTable
{
     ...
     *
     * @param \App\Models\ColecaoAtributo $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(ColecaoAtributo $model)
    {
    ...
    {
        return $this->builder()
            ->setTableId('colecao_atributos-table')
    ...
    {
        $model = new ColecaoAtributo();
        return [
            Column::make('colecao')->title($model->getAttributeLabel('colecao')),
    ...
    {
        return 'colecao_atributos_' . date('YmdHis');
    }
}
