...
class FormaHerbaceaAtributoDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('forma_herbacea', function($formaHerbaceaAtributo){
                return $formaHerbaceaAtributo->forma_herbacea;
            })
     ...
     *
     * @param \App\Models\FormaHerbaceaAtributo $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(FormaHerbaceaAtributo $model)
    {
    ...
    {
        return $this->builder()
            ->setTableId('forma_herbacea_atributos-table')
    ...
    {
        return 'forma_herbacea_atributos_' . date('YmdHis');
    }
}
