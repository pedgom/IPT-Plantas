...
class DiametroAtributoDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($diametroAtributo) {
                return '<a class="btn btn-sm btn-bg-light btn-color-primary btn-icon" href="'. route('diametro-atributos.show', $diametroAtributo) .'" title="'. __('View') .'">'. theme()->getSvgIcon("icons/duotune/general/gen004.svg", "svg-icon-2") .'</a>
                        <a class="btn btn-sm btn-bg-light btn-color-primary btn-icon" href="'. route('diametro-atributos.edit', $diametroAtributo) .'" title="'. __('Edit') .'">'. theme()->getSvgIcon("icons/duotune/art/art005.svg", "svg-icon-2") .'</a>
                        <button class="btn btn-sm btn-bg-light btn-color-primary btn-icon delete-confirmation" data-destroy-form-id="destroy-form-'. $diametroAtributo->id .'" data-delete-url="'. route('diametro-atributos.destroy', $diametroAtributo) .'" onclick="destroyConfirmation(this)" title="'. __('Delete') .'">'. theme()->getSvgIcon("icons/duotune/general/gen027.svg", "svg-icon-2") .'</button>';
            })
     ...
     *
     * @param \App\Models\DiametroAtributo $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DiametroAtributo $model)
    {
    ...
    {
        return $this->builder()
            ->setTableId('diametro_atributos-table')
    ...
    {
        return 'diametro_atributos_' . date('YmdHis');
    }
}
