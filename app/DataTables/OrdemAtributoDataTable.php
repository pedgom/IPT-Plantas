...
class OrdemAtributoDataTable extends DataTable
{
     ...
     *
     * @param \App\Models\OrdemAtributo $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(OrdemAtributo $model)
    {
    ...
    {
        return $this->builder()
            ->setTableId('ordem_atributos-table')
    ...
    {
        return 'ordem_atributos_' . date('YmdHis');
    }
}
