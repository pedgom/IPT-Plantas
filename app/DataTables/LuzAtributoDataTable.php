...
class LuzAtributoDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($luzAtributo) {
                return '<a class="btn btn-sm btn-bg-light btn-color-primary btn-icon" href="'. route('luz-atributos.show', $luzAtributo) .'" title="'. __('View') .'">'. theme()->getSvgIcon("icons/duotune/general/gen004.svg", "svg-icon-2") .'</a>
                        <a class="btn btn-sm btn-bg-light btn-color-primary btn-icon" href="'. route('luz-atributos.edit', $luzAtributo) .'" title="'. __('Edit') .'">'. theme()->getSvgIcon("icons/duotune/art/art005.svg", "svg-icon-2") .'</a>
                        <button class="btn btn-sm btn-bg-light btn-color-primary btn-icon delete-confirmation" data-destroy-form-id="destroy-form-'. $luzAtributo->id .'" data-delete-url="'. route('luz-atributos.destroy', $luzAtributo) .'" onclick="destroyConfirmation(this)" title="'. __('Delete') .'">'. theme()->getSvgIcon("icons/duotune/general/gen027.svg", "svg-icon-2") .'</button>';
            })
     ...
     *
     * @param \App\Models\LuzAtributo $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(LuzAtributo $model)
    {
    ...
    {
        return $this->builder()
            ->setTableId('luz_atributos-table')
    ...
    {
        return 'luz_atributos_' . date('YmdHis');
    }
}
