...
class UsoAtributoDataTable extends DataTable
{
     ...
     *
     * @param \App\Models\UsoAtributo $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(UsoAtributo $model)
    {
    ...
    {
        return $this->builder()
            ->setTableId('uso_atributos-table')
    ...
    {
        $model = new UsoAtributo();
        return [
            Column::make('uso')->title($model->getAttributeLabel('uso')),
    ...
    {
        return 'uso_atributos_' . date('YmdHis');
    }
}
