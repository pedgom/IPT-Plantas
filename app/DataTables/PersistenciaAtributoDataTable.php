...
class PersistenciaAtributoDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('persistencia', function($persistenciaAtributo){
                return $persistenciaAtributo->persistencia;
            })
     ...
     *
     * @param \App\Models\PersistenciaAtributo $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(PersistenciaAtributo $model)
    {
    ...
    {
        return $this->builder()
            ->setTableId('persistencia_atributos-table')
    ...
    {
        return 'persistencia_atributos_' . date('YmdHis');
    }
}
