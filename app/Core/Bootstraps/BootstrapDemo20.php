...
class BootstrapDemo20 extends BootstrapBase {
	// Private Properties
	...
	private static function initHeader() {
        Theme::addHtmlClass('body', 'header-extended');
	...
	private static function initAsideMenu() {
		self::$asideMenu = new Menu( Theme::getOption('menu', 'demo20-aside'), Theme::getPagePath() );
